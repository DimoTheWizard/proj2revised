    ...
    <body id="roompage">
        ...
        <div class="firstroom">
            ...
            <div class="backgroundforinfo">
                ...
                <br>
                <h1 class="firstparg">Book&nbsp;<a href="reservation_front.php">Here&nbsp;</a> to reserve the room!</h1>
            </div>
        </div>
        <br>
        <div class="all">
            ...
            <div class="child text" id="lastChild">
                <p class="SliderText">First Room</p>
            </div>
        </div>
        <div class="mySlides" id="parent">
            <div class="child numbertext">
            ...
            <div class="child text" id="lastChild">
                <p class="SliderText">Second Room</p>
            </div>
        </div>
        <div class="mySlides" id="parent">
            <div class="child numbertext">
            ...
            <div class="child text" id="lastChild">
                <p class="SliderText">Third Room</p>
            </div>
        </div>
        <div class="arrows">
